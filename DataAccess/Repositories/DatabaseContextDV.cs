...
namespace DataAccess.Repositories
{
    ...
    /// </summary>
    public abstract class DatabaseContextDV : DbContext
    {
        private readonly ICalculadoraDVRepository _calculadoraDigitosVerificadores;
        protected DatabaseContextDV(string cnnString, ICalculadoraDVRepository calculadoraDigitosVerificadores)
            : base(cnnString)
        {
